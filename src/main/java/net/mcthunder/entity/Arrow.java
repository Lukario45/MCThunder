...
public class Arrow extends Projectile {
    ...
    public Packet getPacket() {
        return new ServerSpawnObjectPacket(this.entityID, null, ObjectType.TIPPED_ARROW, new ProjectileData(getOwnerID()), this.location.getX(), this.location.getY(), this.location.getZ(),
