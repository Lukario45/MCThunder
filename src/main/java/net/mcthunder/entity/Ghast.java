...
public class Ghast extends LivingEntity {
    ...
    public Packet getPacket() {
        return new ServerSpawnMobPacket(this.entityID,null, MobType.GHAST, this.location.getX(), this.location.getY(), this.location.getZ(), this.location.getYaw(),
    ...
    public BuiltinSound getHurtSound() {
        return BuiltinSound.ENTITY_GHAST_HURT;
    }
