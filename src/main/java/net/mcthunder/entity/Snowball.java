...
public class Snowball extends Projectile {
    ...
    public Packet getPacket() {
        return new ServerSpawnObjectPacket(this.entityID, ObjectType.SNOWBALL, new ProjectileData(getOwnerID()), this.location.getX(), this.location.getY(), this.location.getZ(),
