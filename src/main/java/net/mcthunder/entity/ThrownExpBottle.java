...
public class ThrownExpBottle extends Projectile {
    ...
    public Packet getPacket() {
        return new ServerSpawnObjectPacket(this.entityID, ObjectType.EXP_BOTTLE, new ProjectileData(getOwnerID()), this.location.getX(), this.location.getY(), this.location.getZ(),
