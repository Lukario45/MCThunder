...
public class Silverfish extends LivingEntity {
    ...
    public Packet getPacket() {
        return new ServerSpawnMobPacket(this.entityID, MobType.SILVERFISH, this.location.getX(), this.location.getY(), this.location.getZ(), this.location.getYaw(),
    ...
    public GenericSound getDeathSound() {
        return GenericSound.SILVERFISH_DEATH;
    }

    @Override
    public GenericSound getHurtSound() {
        return GenericSound.SILVERFISH_HURT;
    }
}