...
public class Minecart extends Entity {
    ...
    public Packet getPacket() {
        return new ServerSpawnObjectPacket(this.entityID,null, ObjectType.MINECART, MinecartType.NORMAL, this.location.getX(), this.location.getY(), this.location.getZ(),
