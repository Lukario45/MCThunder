...
import net.mcthunder.protocol.packet.ingame.client.window.*;
import net.mcthunder.protocol.packet.ingame.client.world.ClientUpdateSignPacket;
import net.mcthunder.protocol.packet.ingame.server.*;
import net.mcthunder.protocol.packet.ingame.server.entity.*;
import net.mcthunder.protocol.packet.ingame.server.entity.player.*;
import net.mcthunder.protocol.packet.ingame.server.entity.spawn.*;
import net.mcthunder.protocol.packet.ingame.server.scoreboard.ServerDisplayScoreboardPacket;
import net.mcthunder.protocol.packet.ingame.server.scoreboard.ServerScoreboardObjectivePacket;
import net.mcthunder.protocol.packet.ingame.server.scoreboard.ServerTeamPacket;
import net.mcthunder.protocol.packet.ingame.server.scoreboard.ServerUpdateScorePacket;
import net.mcthunder.protocol.packet.ingame.server.window.*;
import net.mcthunder.protocol.packet.ingame.server.world.*;
