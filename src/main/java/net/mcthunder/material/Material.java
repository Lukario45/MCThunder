...
public enum Material {//http://minecraft.gamepedia.com/Id
    ...
    WHEAT_BLOCK_1_4("WHEAT_BLOCK_1_4", WHEAT_BLOCK, (short) 1),
    WHEAT_BLOCK_3_8("WHEAT_BLOCK_3_8", WHEAT_BLOCK, (short) 2),
    WHEAT_BLOCK_1_2("WHEAT_BLOCK_1_2", WHEAT_BLOCK, (short) 3),
    WHEAT_BLOCK_5_8("WHEAT_BLOCK_5_8", WHEAT_BLOCK, (short) 4),
    WHEAT_BLOCK_3_4("WHEAT_BLOCK_3_4", WHEAT_BLOCK, (short) 5),
    ...
    SNOW_LAYER_1_4("SNOW_LAYER_1_4", SNOW_LAYER, (short) 1),
    SNOW_LAYER_3_8("SNOW_LAYER_3_8", SNOW_LAYER, (short) 2),
    SNOW_LAYER_1_2("SNOW_LAYER_1_2", SNOW_LAYER, (short) 3),
    SNOW_LAYER_5_8("SNOW_LAYER_5_8", SNOW_LAYER, (short) 4),
    SNOW_LAYER_3_4("SNOW_LAYER_3_4", SNOW_LAYER, (short) 5),
    ...
    CAKE_BLOCK_2_3("CAKE_BLOCK_2_3", CAKE_BLOCK, (short) 2),
    CAKE_BLOCK_1_2("CAKE_BLOCK_1_2", CAKE_BLOCK, (short) 3),
    CAKE_BLOCK_1_3("CAKE_BLOCK_1_3", CAKE_BLOCK, (short) 4),
    ...
    WHITE_STAINED_GLASS("WHITE_STAINED_GLASS", STAINED_GLASS, (short) 0),
    ORANGE_STAINED_GLASS("ORANGE_STAINED_GLASS", STAINED_GLASS, (short) 1),
    MAGENTA_STAINED_GLASS("MAGENTA_STAINED_GLASS", STAINED_GLASS, (short) 2),
    LIGHT_BLUE_STAINED_GLASS("LIGHT_BLUE_STAINED_GLASS", STAINED_GLASS, (short) 3),
    YELLOW_STAINED_GLASS("YELLOW_STAINED_GLASS", STAINED_GLASS, (short) 4),
    LIME_STAINED_GLASS("LIME_STAINED_GLASS", STAINED_GLASS, (short) 5),
    PINK_STAINED_GLASS("PINK_STAINED_GLASS", STAINED_GLASS, (short) 6),
    GRAY_STAINED_GLASS("GRAY_STAINED_GLASS", STAINED_GLASS, (short) 7),
    LIGHT_GRAY_STAINED_GLASS("LIGHT_GRAY_STAINED_GLASS", STAINED_GLASS, (short) 8),
    CYAN_STAINED_GLASS("CYAN_STAINED_GLASS", STAINED_GLASS, (short) 9),
    PURPLE_STAINED_GLASS("PURPLE_STAINED_GLASS", STAINED_GLASS, (short) 10),
    BLUE_STAINED_GLASS("BLUE_STAINED_GLASS", STAINED_GLASS, (short) 11),
    BROWN_STAINED_GLASS("BROWN_STAINED_GLASS", STAINED_GLASS, (short) 12),
    GREEN_STAINED_GLASS("GREEN_STAINED_GLASS", STAINED_GLASS, (short) 13),
    RED_STAINED_GLASS("RED_STAINED_GLASS", STAINED_GLASS, (short) 14),
    BLACK_STAINED_GLASS("BLACK_STAINED_GLASS", STAINED_GLASS, (short) 15),
    ...
    NETHER_WART_STALK_1_2("NETHER_WART_STALK_1_2", NETHER_WART_STALK, (short) 1),
    NETHER_WART_STALK_3_4("NETHER_WART_STALK_3_4", NETHER_WART_STALK, (short) 2),
    NETHER_WART_STALK_FULL("NETHER_WART_STALK_FULL", NETHER_WART_STALK, (short) 3),
    ...
    CAULDRON_BLOCK_FULL("CAULDRON_BLOCK_FULL", CAULDRON_BLOCK, (short) 3),
    ...
    COCOA_BLOCK_SOUTH_FULL("COCOA_BLOCK_SOUTH_FULL", COCOA_BLOCK, (short) 8),
    COCOA_BLOCK_WEST_FULL("COCOA_BLOCK_WEST_FULL", COCOA_BLOCK, (short) 9),
    COCOA_BLOCK_NORTH_FULL("COCOA_BLOCK_NORTH_FULL", COCOA_BLOCK, (short) 10),
    COCOA_BLOCK_EAST_FULL("COCOA_BLOCK_EAST_FULL", COCOA_BLOCK, (short) 11),
    ...
    CARROT_BLOCK_1_4("CARROT_BLOCK_1_4", CARROT_BLOCK, (short) 1),
    CARROT_BLOCK_3_8("CARROT_BLOCK_3_8", CARROT_BLOCK, (short) 2),
    CARROT_BLOCK_1_2("CARROT_BLOCK_1_2", CARROT_BLOCK, (short) 3),
    CARROT_BLOCK_5_8("CARROT_BLOCK_5_8", CARROT_BLOCK, (short) 4),
    CARROT_BLOCK_3_4("CARROT_BLOCK_3_4", CARROT_BLOCK, (short) 5),
    CARROT_BLOCK_7_8("CARROT_BLOCK_7_8", CARROT_BLOCK, (short) 6),
    CARROT_BLOCK_FULL("CARROT_BLOCK_FULL", CARROT_BLOCK, (short) 7),
    POTATO_BLOCK("POTATO_BLOCK", 142),
    POTATO_BLOCK_1_8("POTATO_BLOCK_1_8", POTATO_BLOCK, (short) 0),
    POTATO_BLOCK_1_4("POTATO_BLOCK_1_4", POTATO_BLOCK, (short) 1),
    POTATO_BLOCK_3_8("POTATO_BLOCK_3_8", POTATO_BLOCK, (short) 2),
    POTATO_BLOCK_1_2("POTATO_BLOCK_1_2", POTATO_BLOCK, (short) 3),
    POTATO_BLOCK_5_8("POTATO_BLOCK_5_8", POTATO_BLOCK, (short) 4),
    POTATO_BLOCK_3_4("POTATO_BLOCK_3_4", POTATO_BLOCK, (short) 5),
    POTATO_BLOCK_7_8("POTATO_BLOCK_7_8", POTATO_BLOCK, (short) 6),
    POTATO_BLOCK_FULL("POTATO_BLOCK_FULL", POTATO_BLOCK, (short) 7),
    ...
    WHITE_STAINED_CLAY("WHITE_STAINED_GLASS", STAINED_HARDENED_CLAY, (short) 0),
    ORANGE_STAINED_CLAY("ORANGE_STAINED_GLASS", STAINED_HARDENED_CLAY, (short) 1),
    MAGENTA_STAINED_CLAY("MAGENTA_STAINED_GLASS", STAINED_HARDENED_CLAY, (short) 2),
    LIGHT_BLUE_STAINED_CLAY("LIGHT_BLUE_STAINED_GLASS", STAINED_HARDENED_CLAY, (short) 3),
    YELLOW_STAINED_CLAY("YELLOW_STAINED_GLASS", STAINED_HARDENED_CLAY, (short) 4),
    LIME_STAINED_CLAY("LIME_STAINED_CLAY", STAINED_HARDENED_CLAY, (short) 5),
    PINK_STAINED_CLAY("PINK_STAINED_CLAY", STAINED_HARDENED_CLAY, (short) 6),
    GRAY_STAINED_CLAY("GRAY_STAINED_CLAY", STAINED_HARDENED_CLAY, (short) 7),
    LIGHT_GRAY_STAINED_CLAY("LIGHT_GRAY_STAINED_CLAY", STAINED_HARDENED_CLAY, (short) 8),
    CYAN_STAINED_CLAY("CYAN_STAINED_CLAY", STAINED_HARDENED_CLAY, (short) 9),
    PURPLE_STAINED_CLAY("PURPLE_STAINED_CLAY", STAINED_HARDENED_CLAY, (short) 10),
    BLUE_STAINED_CLAY("BLUE_STAINED_CLAY", STAINED_HARDENED_CLAY, (short) 11),
    BROWN_STAINED_CLAY("BROWN_STAINED_CLAY", STAINED_HARDENED_CLAY, (short) 12),
    GREEN_STAINED_CLAY("GREEN_STAINED_CLAY", STAINED_HARDENED_CLAY, (short) 13),
    RED_STAINED_CLAY("RED_STAINED_CLAY", STAINED_HARDENED_CLAY, (short) 14),
    BLACK_STAINED_CLAY("BLACK_STAINED_CLAY", STAINED_HARDENED_CLAY, (short) 15),
    STAINED_GLASS_PANE("STAINED_GLASS_PANE", 160),
    WHITE_STAINED_GLASS_PANE("WHITE_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 0),
    ORANGE_STAINED_GLASS_PANE("ORANGE_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 1),
    MAGENTA_STAINED_GLASS_PANE("MAGENTA_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 2),
    LIGHT_BLUE_STAINED_GLASS_PANE("LIGHT_BLUE_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 3),
    YELLOW_STAINED_GLASS_PANE("YELLOW_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 4),
    LIME_STAINED_GLASS_PANE("LIME_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 5),
    PINK_STAINED_GLASS_PANE("PINK_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 6),
    GRAY_STAINED_GLASS_PANE("GRAY_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 7),
    LIGHT_GRAY_STAINED_GLASS_PANE("LIGHT_GRAY_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 8),
    CYAN_STAINED_GLASS_PANE("CYAN_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 9),
    PURPLE_STAINED_GLASS_PANE("PURPLE_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 10),
    BLUE_STAINED_GLASS_PANE("BLUE_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 11),
    BROWN_STAINED_GLASS_PANE("BROWN_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 12),
    GREEN_STAINED_GLASS_PANE("GREEN_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 13),
    RED_STAINED_GLASS_PANE("RED_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 14),
    BLACK_STAINED_GLASS_PANE("BLACK_STAINED_GLASS_PANE", STAINED_GLASS_PANE, (short) 15),
    LEAVES2("LEAVES2", 161),
    ...
    ENCHANTED_GOLDEN_APPLE("ENCHANTED_GOLDEN_APPLE", GOLDEN_APPLE, (short) 1),
    SIGN("SIGN", 323),
