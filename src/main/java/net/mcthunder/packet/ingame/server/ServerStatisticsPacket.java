...
public class ServerStatisticsPacket
    ...
    public void read(NetIn in) throws IOException {
        ...
        for (int index = 0; index < length; index++)
            this.statistics.put(in.readString(), Integer.valueOf(in.readVarInt()));
    }
