...
import net.mcthunder.game.essentials.PlayerInfo;
import net.mcthunder.game.essentials.ServerStatusInfo;
import net.mcthunder.game.essentials.VersionInfo;
...
public class StatusResponsePacket
    ...
    public void write(NetOut out) throws IOException {
        ...
        ver.addProperty("protocol", Integer.valueOf(this.info.getVersionInfo().getProtocolVersion()));
        JsonObject plrs = new JsonObject();
        plrs.addProperty("max", Integer.valueOf(this.info.getPlayerInfo().getMaxPlayers()));
        plrs.addProperty("online", Integer.valueOf(this.info.getPlayerInfo().getOnlinePlayers()));
        ...
        if (this.info.getIcon() != null) {
            obj.addProperty("favicon", iconToString(this.info.getIcon()));
        }
